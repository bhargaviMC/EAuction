...
namespace EAuctionApp.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterModel model)
        {
            ...
            if (userExists != null)
                return StatusCode(StatusCodes.Status500InternalServerError, new ResponseModel { IsSuccess = false, Messsage = "User already exists!" });
            ...
            if (!result.Succeeded)
                return StatusCode(StatusCodes.Status500InternalServerError, new ResponseModel { IsSuccess = false, Messsage = "User creation failed! Please check user details and try again." });

            return Ok(new ResponseModel { IsSuccess = true, Messsage = "User created successfully!" });
        }
